...
echo "$(cat SCANS/192.168.254.136/nikto_simplu | sed -e 1d | head -n -1)" >> SCANS/$1/raport_nikto
echo "" >> SCANS/$1/raport_nikto
echo "$(cat SCANS/192.168.254.136/nikto_ssl | sed -e 1d | head -n -1)" >> SCANS/$1/raport_nikto
